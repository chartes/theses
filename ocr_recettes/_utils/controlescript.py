...
def test_file(name_file, d_recollement):
    ...
    return list(flat_gen([name_file, rep_number_head, rep_pagination, rep_check_image,rep_ocr, rep_structure,rep_metadata]))
